...
4. Setup and configure minikube (using [This setup](https://github.com/dsgov-acme/cwb01-local-environment))

## Run Locally

1. To just spin up the service in `minikube`, run this command: `skaffold run`
2. [view docs](http://api.cwb01.test/ns/swagger-ui/index.html)
...
3. Add host as `db.cwb01.test` and the port as `30201`
